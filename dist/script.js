...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_sliders_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  ...
  showUpSlider.init();
  var moduleSlider = new _modules_sliders_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  new _modules_player__WEBPACK_IMPORTED_MODULE_2__["default"]('.play', '.overlay').init();
  new _modules_player__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay').init();
  new _modules_showInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.plus').bindTriggers();
  new _modules_download__WEBPACK_IMPORTED_MODULE_6__["default"]('.download').bindTriggers();
});
...
/*#__PURE__*/
function () {
  function Player(trigger, modalSelector) {
...
/*#__PURE__*/
function () {
  function ShowInfo(triggerSelector) {
    ...
    value: function bindTriggers() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var message = btn.closest('.module__info-show').nextElementSibling;
...
function (_Slider) {
  ...
  function MainSlider(page, btns, moduleNexts, modulePrevs) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, page, btns, moduleNexts, modulePrevs));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            _this.hansonBlock.style.opacity = 1;

            _this.hansonBlock.classList.add('animated', 'slideInUp');
          }, 3000);
        } else {
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (item) {
        ...
        item.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this2.currentSlideIndex = 1;

          _this2.showSlides(_this2.currentSlideIndex);
        });
      });
      this.moduleNexts.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
      ...
      this.modulePrevs.forEach(function (item) {
        item.addEventListener('click', function (e) {
          e.preventDefault();
          e.stopPropagation();
