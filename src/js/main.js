...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const moduleSlider = new SliderMini({container: '.modules__content-slider', next: '.modules__info-btns .slick-next', activeClass: '.card-active', animated: true, prev: '.modules__info-btns .slick-prev'});
    moduleSlider.init();
